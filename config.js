...
- The bot also has many more built-in commands beyond what you can trigger yourself as tools — Islamic tools (prayer times, Qibla, Hijri date), group tools (tag everyone, remove a member), fun stuff (jokes, shayari, riddles, polls), utilities (currency conversion, QR codes, calculator, reminders), and more social downloads (Instagram, Facebook, Twitter/X). You don't need to know every detail of these — just know they exist.
